...
public class sample_ScoreController : MonoBehaviour
{
    ...
    private sample_battle_gamemanager Mybattle_gamemanager;

    void Start()
    {
        Mybattle_gamemanager=GameObject.Find("BattleGameManager").GetComponent<sample_battle_gamemanager>();
    }
    void Update()
    {
        if(WillChangeScore)
